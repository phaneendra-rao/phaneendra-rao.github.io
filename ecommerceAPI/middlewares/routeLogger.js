...
let requestIpLogger = (req, res, next) => {
    ...
    logger.information(`${req.method} Request Made from ${remoteIp} for route ${req.originalUrl}`,'routeLoggerMiddleWare: requestIpLogger',4);

    if(req.method === 'OPTIONS')
    {
        console.log('!OPTIONS');
        logger.information('!OPTIONS','routeLoggerMiddleWare: requestIpLogger',3);
