...
let errorHandler = (err, req, res, next) => {
    logger.information(`Some error occured at global level : ${err}.`,'appErrorHandler: errorHandler',10);
...
let notFoundHandler = (req, res, next) => {
    logger.information('Route not found in the application.','appErrorHandler: notFoundHandler',5);
